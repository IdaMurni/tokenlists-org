  ...
  return (
    <Hero>
      <span style={{ marginBottom: '1rem' }}>
        Maintained by {' '}
        <a href="https://exchange.idamurni.de" className="idamurni">
          IdaMurni
        </a>{' '}
      </span>

      <p className="title">An Polygon token list standard.</p>
      ...
      <HoverLink target="_blank" rel="noopener noreferrer" href="https://discord.gg/bpnRphBxFp">
        {'->'} Community
      </HoverLink>
    </Hero>
  )
